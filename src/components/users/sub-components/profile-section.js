const ProfileSection = () => {
  return (
    <div className="row candidate-section mx-auto">
      <div className="col-sm-8">
        <div className="row">
          <div className="col-sm-1">
            <div className="profile">J D</div>
          </div>
          <div className="col-sm-5">
            <div className="row">
              <div className="col-sm-6 profile-name">John Doe</div>
              <div className="col-sm-6 profile-status">
                <span>Interview</span>
              </div>
            </div>

            <div className="row">
              <div className="col-sm-6 profile-email-section">
                John.Doe@gmail.com
              </div>

              <div className="col-sm-6 profile-telephone-section">
                <span>+250 788 492 456</span>
              </div>
            </div>
          </div>
          {/* this section remain empty ---------------------------------- */}
          <div
            className="col-sm-5"
            style={{ borderRight: "1px solid grey", color: "transparent" }}
          >
            jjj
          </div>
        </div>
      ...
      {/* current status section start here ---------------------------------- */}
      <div className="col-sm-3">
        <div className="current-status-section">
          <div className="current-status-title">Current Status</div>
          <div className="row">
            <div className="col-sm-6 dim-text">Round</div>
            <div className="col-sm-6 current-status-position">
              <span style={{ width: "100%" }}>Technical</span>
            </div>
          </div>
          <div className="row">
            <div className="col-sm-6 dim-text">Assigned to</div>
            <div className="col-sm-6 current-status-profile">
              <div className="current-status-profile-pic">
                <img style={{ width: "100%" }} src="../../../profile.jfif" />
              </div>
              <span>John Doe</span>
            </div>
          </div>
          <div className="row">
            <div className="col-sm-6 dim-text">Interview Date</div>
            <div className="col-sm-6 dim-text">Jul 30, 2024</div>
          </div>
        </div>
      </div>
    </div>
